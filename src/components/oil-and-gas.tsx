            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#333333] rounded-lg p-6 relative">
                        <div className="text-4xl font-bold text-[#D1D1D1] mb-8 text-right">01</div>
                    ...
                    {/* Service 2 */}
                    <div className="bg-[#333333] rounded-lg p-6 relative">
                        <div className="text-4xl font-bold text-[#D1D1D1] mb-8 text-right">02</div>
                        <div className="text-blue-400 mb-4">
                            <img src={oilwell} alt="" />
                        </div>
                    ...
                    {/* Service 3 */}
                    <div className="bg-[#333333] rounded-lg p-6 relative">
                        <div className="text-4xl font-bold text-[#D1D1D1] mb-8 text-right">03</div>
                        <div className="text-blue-400 mb-4">
                            {/* <Truck size={32} /> */}
                            <img src={oilcar} alt="" />
                        </div>
                        <h3 className="text-xl font-bold mb-3">Direct Sales & Delivery</h3>
                        <p className="text-sm text-[#F9F9F9]">We supply premium petroleum products straight to your doorstep.</p>
                    </div>
                </div>
            </div>
        </section>
