        ...
        <div className="mx-auto px-4 py-12 max-w-7xl">
            <div className="flex flex-col md:flex-row items-start justify-between gap-8">
                <div className="max-w-xl">
                    <h1 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-4">Solar Energy</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="relative p-6 bg-[#E2E2E240] rounded-lg border border-[#F5F5F5] shadow-[0_4px_20px_0_#E2E2E240]">
                    <div className="text-6xl font-light text-[#D1D1D1] absolute top-4 right-4">01</div>
                    <div className="mb-4">
                        <img src={money} alt="" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Solar Panel Supply</h3>
                    <p className="text-[#767676]">We source high-quality, long-lasting solar panels for homes and businesses.</p>
                </div>

                {/* Service 2 */}
                <div className="relative p-6 bg-[#E2E2E240] rounded-lg border border-[#F5F5F5] shadow-[0_4px_20px_0_#E2E2E240]">
                    <div className="text-6xl font-light text-[#D1D1D1] absolute top-4 right-4">02</div>
                ...
                {/* Service 3 */}
                <div className="relative p-6 bg-[#E2E2E240] rounded-lg border border-[#F5F5F5] shadow-[0_4px_20px_0_#E2E2E240]">
                    <div className="text-6xl font-light text-[#D1D1D1] absolute top-4 right-4">03</div>
                    <div className="mb-4">
                        <img src={oilttruck} alt="" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Battery & Inverter Systems</h3>
                    <p className="text-[#767676]">
